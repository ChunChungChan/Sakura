...
"layout (location = 1) in vec4 aColor;  // Color in attribute location 1\n"
"out vec4 theColor;					// output a color to the fragment shader\n"
...
"#version 330 core\n"
"in vec4 theColor;		// Color value came from the vertex shader (smoothed) \n"
"out vec4 FragColor;	// Color that will be used for the fragment\n"
"void main()\n"
"{\n"
"   FragColor = vec4(theColor);   // Add alpha value of 1.0.\n"
"}\n\0";
